...
app.config(function($translateProvider) {
  ...
  $translateProvider.translations('en', {
      ...
      pdfResume: "You can also <a href='asset/cv.pdf'>download</a> my PDF resume",
  ...
  $translateProvider.translations('fr', {
      ...
      pdfResume: "Vous pouvez aussi <a href='asset/cv.pdf' target='_blank'>télécharger</a> mon CV au format PDF",
