...
app.config(function($translateProvider) {
  ...
  $translateProvider.translations('en', {
      ...
      pdfResume: "You can also <a href='#0'>download</a> my PDF resume",
  ...
  $translateProvider.translations('fr', {
      ...
      hello: "Salut, je m'appelle <span class='hand'>Jordan</span>",
      ...
      pdfResume: "Vous pouvez aussi <a href='#0' target='_blank'>télécharger</a> mon CV au format PDF",
  ...
  $translateProvider.translations('it', {
      ...
      "sub-hello" : 'Giovanne programmatore, appassionato di tutti i tipi di nuove tecnologie',
      ...
      bachelorCPE: "Comincio il mio diploma d'ingegnere",
      timelineMoreInfosBtn: "Leggere di più",
      ...
      contact: "<span class='mdi-communication-email'></span> Contatto",
      connect: "<span class='icon-linkedin'></span> Connessione",
      follow: "<span class='icon-github'></span> Seguirmi",
      pdfResume: "<a href='#0' target='_blank'>Scaricare</a> il mio CV, in francese, al formatto PDF",
      connectFooter: "Connessione",
      agility: "Agilità",
      javaContent: "Ho cominciato Java durante il mio diploma Universitario. Considerato IL LINGUAGGIO oggi. No ho lavorato molto con lui, pero mi piacerebbe.",
      "c++Content": "Ho anche imparato c++ duranete il mio Diploma Universitario.",
      javascriptContent: "Il linguaggio che mi piacce du più. Si puo fare tante cose con javascript e ci sono tante librerie da discovere. La sua evoluzione è molto interessante.",
      expressContent: "Non ho mai usato Nodejs da solo, sempre con Express, su piccoli progietti (personali o di scuola) con MongoDB o Redis.",
      perlContent: "Ho lavorato con questo linguaggio durante un anno, come script o object-oriented.",
      shellContent: "Uso sempre questo linguaggio per qualsiasi manipulazione on UNIX. Quello che dà Linux il suo fascino.",
      gitContent: "Ho scoperto Git durante una formazion di fine Diploma. È stato una revelazione. Secondo me non si puo essere programatore senza conosciere questo strumento.",
      agilityContent: "Sono uno di questi programatore, ancora giovane che pensa che l'agilità è un modo di vità, forse perchè non ho mai provato un vero progietto Agile. Spero provarne uno presto.",
      readMoreSkills: "Leggere di più"
  });
